...
parser.add_argument("--delta_scale", type=str, default="log-scale", help="How to sample the delta")
...
if delta_scale == "log-scale":
    delta_range = np.logspace(np.log10(min_delta), np.log10(max_delta), num_delta)
else:
