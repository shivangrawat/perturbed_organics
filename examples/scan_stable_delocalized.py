...
parser.add_argument('--max_input', type=int, default=5, help="Maximum value of the parameter input")
parser.add_argument('--max_delta', type=int, default=5, help="Maximum value of the parameter delta")
